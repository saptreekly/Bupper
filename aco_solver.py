...
class ACO:
    ...
    def construct_solution(self, 
        ...
        path = [current]
        current_time = 0.0
        node_arrival_times = {start: current_time}
        ...
        while unvisited:
            ...
            current = next_city
            if time_windows and next_city in time_windows:
                tw = time_windows[next_city]
        ...
        # Return to depot
        path.append(start)
        final_travel_time = distances[current][start] / self.speed
        node_arrival_times[start] = current_time + final_travel_time
        ...
        for _ in range(n_iterations):
            ...
            for _ in range(self.n_ants):
                path, arrival_times = self.construct_solution(
                    0, distances, pheromone, time_windows)
